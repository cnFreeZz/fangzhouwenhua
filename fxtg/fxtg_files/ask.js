...
$("#case").fadeOut(400);
        ...
        $(".top_b_like").on("click",function(){
            if(!isLike){
                $(this).children("img").attr("src","../adsource.b0.upaiyun.com/fage/diaocha/http__/fx-cnd-oss.wochouji.cn/kepu-zise/images/top_b_like_on.html");
                var LikeNum = parseInt($(this).children("span").html());
                $(this).children("span").html(LikeNum + 1);
                isLike = true;
            }else{
                $(this).children("img").attr("src","../adsource.b0.upaiyun.com/fage/diaocha/http__/fx-cnd-oss.wochouji.cn/kepu-zise/images/top_b_like.html");
                var LikeNum = parseInt($(this).children("span").html());
                $(this).children("span").html(LikeNum - 1);
                isLike = false;
            }
